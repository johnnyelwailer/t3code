 ...
 * (split across several `t3team-sdk.engine.*.test.ts` modules for additive-guard LOC
...
import type * as AgentPrimitiveWorkflow from "./__fixtures__/t3team-sdk.agentPrimitive.workflow.ts";
import type * as AskChoiceJsonWorkflow from "./__fixtures__/t3team-sdk.askChoiceJson.workflow.ts";
import type * as AskChoiceWorkflow from "./__fixtures__/t3team-sdk.askChoice.workflow.ts";
...
export const budgetWorkflow = defineWorkflow<typeof BudgetWorkflow>(
  "./__fixtures__/t3team-sdk.budgetPrimitive.workflow.ts",
);
export const parallelWorkflow = defineWorkflow<typeof ParallelWorkflow>(
  "./__fixtures__/t3team-sdk.parallelPrimitive.workflow.ts",
);
export const pipelineWorkflow = defineWorkflow<typeof PipelineWorkflow>(
  "./__fixtures__/t3team-sdk.pipelinePrimitive.workflow.ts",
);
