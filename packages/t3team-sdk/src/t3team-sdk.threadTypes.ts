 ...
 * `model` may be a typed `ModelRef` from `@t3team/sdk/models` or a raw provider slug (custom
 ...
 * the same availability check `t3team.thread.start_child` uses for cross-provider spawning. When
