...
} from "./t3team-sdk.journal.ts";
import type { JournalEntry, JournalMaps } from "./t3team-sdk.journalReader.ts";
...
import {
  ...
  toResolvedWire,
  toWire,
} from "./t3team-sdk.journalWriter.ts";
...
/** Default runs root: `.t3team-runs/` under the cwd (the on-disk MVP shape doc 25 documents). */
 ...
 * `.t3team-runs/<run-id>/journal.jsonl` + a sibling `runMeta.json`. Keeps the SDK's own
