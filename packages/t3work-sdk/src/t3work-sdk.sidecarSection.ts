...
/**
 * The `sidecar.section` placement helper (Epic 19 §Plugin SDK Surface, status "Built (Phase 5a)").
 * Owned by the SDK — the public authoring surface — and re-exported by
 * `@t3tools/project-recipes` (`src/sidecarSection.ts`) for its existing importers.
 */
import * as Schema from "effect/Schema";

import { RecipeSurface } from "./t3work-sdk.surface.ts";
