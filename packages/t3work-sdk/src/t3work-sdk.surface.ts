 ...
 *
 * It lives in the SDK because the SDK is the lower layer: `@t3work/sdk` is the public authoring
 * surface (Epic 10 §Package Boundaries) and depends on nothing else in the t3work workspace, so
