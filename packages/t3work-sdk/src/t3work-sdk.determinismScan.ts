 ...
 * exactly those as journaled globals ({@link ./t3work-sdk.workflowGlobals.ts}), so flagging them
...
import { UNJOURNALED_GLOBALS } from "./t3work-sdk.determinismGlobals.ts";
...
} from "./t3work-sdk.staticAuditTypes.ts";
