 ...
 * run both scans over it — determinism ({@link ./t3work-sdk.determinismScan.ts}) and
 * `meta.capabilities` ({@link ./t3work-sdk.capabilityScan.ts}). Never executes the body.
 *
 * Wired into the static validate path (`t3work.recipe.validate`) so an authoring agent sees these
...
import { normalizeCapabilities } from "./t3work-sdk.capabilityGating.ts";
import { scanCapabilities } from "./t3work-sdk.capabilityScan.ts";
import { scanDeterminism } from "./t3work-sdk.determinismScan.ts";
import { extractMeta, prepareWorkflow, type WorkflowSource } from "./t3work-sdk.loader.ts";
import type { WorkflowAuditFinding } from "./t3work-sdk.staticAuditTypes.ts";
import { getRegisteredTool } from "./t3work-sdk.ts";
