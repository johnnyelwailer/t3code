/**
 * The unbound-nondeterministic-global table behind {@link ./t3work-sdk.determinismScan.ts}'s
 * `unjournaled-host-global` rule: host globals that are effectful or clock/entropy-reading AND
 * NOT bound in the workflow body context ({@link ./t3work-sdk.workflowGlobals.ts}), so a body
