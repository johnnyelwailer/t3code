 ...
 * (`t3teamExt.attachments`, kind `"view"`); the web renders it as the in-thread "needs your
 ...
 *
 * `affordance` mirrors the SDK's `AskAffordance` descriptor (`@t3team/sdk`
...
export const PROJECT_RECIPE_MESSAGE_VIEW_WORKFLOW_DECISION = "t3team.workflow.decision";
