...
export const PROJECT_RECIPE_TOOL_GROUP_BY_TOOL_ID = {
  ...
  "t3work.recipe.list": PROJECT_RECIPE_INTEGRATION_READ_TOOL_GROUP.id,
  "t3work.orchestration.run": PROJECT_RECIPE_THREAD_HANDOFF_TOOL_GROUP.id,
  "t3work.recipe.validate": PROJECT_RECIPE_INTEGRATION_READ_TOOL_GROUP.id,
  ...
  "t3work.widget.show": PROJECT_RECIPE_VIEW_STATE_TOOL_GROUP.id,
