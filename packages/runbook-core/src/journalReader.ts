/**
 * Read and decode `<runs-root>/<run-id>/journal.jsonl` into the maps the engine replays
...
export const JournalEntrySchema = Schema.Struct({
  ...
  kind: Schema.String,
  /** Tool, script, or primitive registration name supplied by the host or an extension package. */
  refId: Schema.String,
