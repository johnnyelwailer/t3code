...
export const IMPLEMENTED_T3WORK_TOOL_CATALOG = {
  // Backlog view-state + Jira draft-mutation tools live in their own module (with the
  // shared input schemas); spread them first so catalog order stays
  // set_assignee_filter -> drafts -> thread/read tools.
  ...IMPLEMENTED_T3WORK_BACKLOG_TOOL_CATALOG,
  ...IMPLEMENTED_T3WORK_DRAFT_TOOL_CATALOG,
  "t3work.view.read": {
    id: "t3work.view.read",
