...
```text
Everything is overrideable unless a higher-precedence policy locks it.
```
...
- **Override posture:** everything is overrideable by default; managed packs can lock any
  field.
