...
Capacity starts as a **dashboard mode** for implementation continuity, not a per-board view
mode: teams and off-days span boards and sprints, and the page is useful without a backlog
selection. Under [Epic 31](./31-composable-project-views.md), this should become a
