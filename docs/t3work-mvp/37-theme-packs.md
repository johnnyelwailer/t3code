...
Theme packs let a distribution deeply restyle and name the t3work shell without executing pack
...
`labels.appName` owns the primary shell label, for example `Nexi` instead of `T3 Work`. Labels are
