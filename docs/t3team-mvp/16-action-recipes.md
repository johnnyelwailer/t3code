...
| Storybook sidecar/recipe presentation (`RecipeListCard`, `FilterActionCard`, `TopicSection`, `SidecarComposition`)                                                                           | Built (`pnpm storybook` from repo root; stories under `apps/web/src/t3team/**/*.stories.tsx`)                                                         |
