...
Module layout, conventions (t3team- prefixes, additive architecture, constitution,
...
(`t3team-useAtlassianOAuth.ts`), e.g. `http://localhost:5173/oauth/callback` for dev
