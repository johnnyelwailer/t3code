...
baseline. The first `t3team` UI should copy or import the current shell structure,
...
and tied to a `t3team` use case.

## Main Views

### Project List

Shows all known `t3team` projects.
...
- Keep existing T3 interaction patterns unless the `t3team` workflow requires a
  different one.
