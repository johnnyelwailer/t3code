...
Define how t3team injects custom tools into each provider using the most native mechanism available, while keeping additive architecture and constitution constraints.
...
- Additive-first implementation under t3team paths.
...
- One t3team tool contract surface.
...
The t3team tool layer must satisfy all capabilities below across providers.
...
This catalog defines first-class actions and preferred UI surfaces in t3team.
...
| Option                                         | Scope        | Strengths                                                                                          | Risks / Gaps                                                                           | Fit For t3team Contract                                                             | Decision                        |
| ---------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------- |
...
## Implications For The New t3team Tool Contract
...
2. Define first two t3team tools (one read-only, one mutation-preview).
