...
- Add new `t3team-` prefixed files only.
...
- New parser and planner module:
  - `apps/server/src/t3team-provider-tool-injection.ts`
- New integration tests:
  - `apps/server/integration/t3team-provider-tool-injection.integration.test.ts`
  - `apps/server/integration/t3team-provider-tool-injection-codex-cli.integration.test.ts`
...
- Default home path: `.t3team/provider-homes/codex` under `workspaceRoot`.
...
- `T3TEAM_RAW_TOOL_INJECTION_JSON`
