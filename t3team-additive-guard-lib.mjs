...
export function candidateUpstreamCounterpartPaths(filePath, requiredPrefixes) {
  ...
  if (filePath.startsWith("apps/web/src/t3team/")) {
    const remapped = filePath.replace("apps/web/src/t3team/", "apps/web/src/");
    addWithRenamedBaseName(candidates, remapped, withoutPrefix);
  }

  if (filePath.startsWith("apps/web/src/t3team/")) {
    const remapped = filePath.replace("apps/web/src/t3team/", "apps/project-shell/src/");
    addWithRenamedBaseName(candidates, remapped, withoutPrefix);
  }

  if (filePath.includes("/t3team/")) {
    const remapped = filePath.replace("/t3team/", "/");
    addWithRenamedBaseName(candidates, remapped, withoutPrefix);
  }
