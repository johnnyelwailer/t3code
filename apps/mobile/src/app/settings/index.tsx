  ...
  const handleDeviceNotificationsChange = useCallback(
    (enabled: boolean) => {
      ...
      Alert.alert(
        ...
        "Notification permission is controlled by iOS. Open Settings to disable notifications for Nexi AI.",
        [
          { text: "Cancel", style: "cancel" },
          { text: "Open Settings", onPress: () => void Linking.openSettings() },
        ],
      ...
      >
        <View className="gap-3">
          ...
          <Text className="px-2 text-sm leading-[18px] text-foreground-muted">
            Nexi AI works locally without signing in. Cloud features are optional.
          </Text>
        </View>
