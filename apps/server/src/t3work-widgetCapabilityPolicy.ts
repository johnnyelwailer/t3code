...
import type { T3workWidgetFormat } from "./t3work-widgetShowCore.ts";
...
export function resolveWidgetCapabilityPolicy(format: T3workWidgetFormat): WidgetCapabilityPolicy {
  switch (format) {
    case "html":
    case "svg":
