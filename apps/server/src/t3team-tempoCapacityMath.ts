/**
 * Pure Tempo capacity math (see t3team-tempo.ts for the formula and the
 * route entry point). Unit-tested in t3team-tempo.test.ts.
 */
...
export type T3TeamTempoUserCapacity = {
