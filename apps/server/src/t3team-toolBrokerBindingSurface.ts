/**
 * Tool surface construction for t3team tool bindings (split out of
 * `t3team-toolBrokerBinding.ts`): the shared `createToolSurface` that both the
 * thread-bound and prelaunch bindings are built from.
 */
...
> = {
  ...
  /** Manage this thread's child sessions. */
