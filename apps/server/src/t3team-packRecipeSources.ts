 ...
 * shared discovery pipeline (`t3team-projectRecipeDiscoveryPack.ts`), never a forked copy.
 */

import { resolvePackAssetPath, type WorkspacePackScope } from "@t3team/packs";
