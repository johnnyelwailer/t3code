...
const TOPICS: ReadonlyArray<T3TeamHelpTopic> = [
  {
    ...
    title: "Agent orchestration (t3team_workflow_run)",
    summary:
      "How to author t3team_workflow_run bodies — fan-out, sequencing, durable timers/routines, injected globals, and meta.",
