 ...
 * double bridge.
 *
 * @module t3work-pack-driverHarness
 */
import {
  OpenCodeSettings,
  ProviderInstanceId,
...
import type { PackHostCapabilities } from "@t3work/packs";
...
import { openCodeUpstreamConfigContent } from "./t3work-pack-aiProvider.ts";
import { providerInstanceToPack } from "./t3work-pack-driverHarnessWrap.ts";
