 ...
 * {@link ./t3team-projectRecipeDiscoveryModule.ts}).
 */

import type { ProjectRecipeRenderContext } from "@t3tools/project-recipes";
import type { AnyRecipeRef, RecipeDerived } from "@t3team/sdk";
...
/**
 * Best-effort text for surfaces that have NO render context (the agent-facing `t3team.recipe.list`,
