...
const hasExplicitSelection = (selection?: T3TeamBacklogSelectionInput): boolean =>
  Boolean(
    selection?.boardId ||
    selection?.sprintId ||
    selection?.filterId ||
...
export const readCachedBacklogViewRow = Effect.fn("t3team.atlassianBacklogCache.readViewRow")(
  function* (
...
export const hasMirrorRowsForProject = Effect.fn(
  "t3team.atlassianBacklogCache.hasMirrorRowsForProject",
)(function* (input: T3TeamBacklogCacheIdentity) {
...
export const readCachedBacklogIssueRows = Effect.fn("t3team.atlassianBacklogCache.readIssueRows")(
  function* (input: T3TeamBacklogCacheIdentity) {
    const sql = yield* SqlClient.SqlClient;
 ...
 * `idx_t3team_atlassian_backlog_issues_my_work` index.
 */
export const readMyWorkIssueRows = Effect.fn("t3team.atlassianBacklogCache.readMyWorkIssueRows")(
  function* (
    input: T3TeamBacklogCacheIdentity & {
