/**
 * Whether a PACK-shipped path may be executed by `t3work.orchestration.run`.
 *
 ...
 * discovery + precedence merge `t3work.recipe.list` uses and compared on canonical paths.
 *
 * Read-only surfaces (`t3work.recipe.list`, `t3work.recipe.validate`) deliberately keep the broader
...
import { canonicalizePath } from "@t3work/packs";
