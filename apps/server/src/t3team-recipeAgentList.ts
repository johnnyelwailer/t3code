/**
 * `t3team.recipe.list` implementation: an authoring-oriented, read-only inventory of the
 * project's `.t3team/recipes/*` directories. Unlike UI discovery
 * ({@link ./t3team-projectRecipeDiscovery.ts}) it does NOT filter by surface or visibility —
...
import type { ListRecipesToolResult, RecipeListEntry, RecipeToolIssue } from "@t3team/sdk";
