...
import { buildContentsPath, runJsonObject } from "./t3team-github-routes-pr-api.ts";
import type {
      ...
      const base =
        file.status === "added" || !baseRef
          ...
          : fetchRepositoryFileVersion({
              ...
              path: basePath,
              ref: baseRef,
              operation: "t3team.github.pr-context.base-file",
            });
      const head =
        file.status === "removed" || !headRef
          ...
          : fetchRepositoryFileVersion({
              ...
              path,
              ref: headRef,
              operation: "t3team.github.pr-context.head-file",
            });
