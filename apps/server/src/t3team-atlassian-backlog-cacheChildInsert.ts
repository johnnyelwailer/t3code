 ...
 */
export const insertCachedT3TeamAtlassianBacklogChildIssue = Effect.fn(
  "t3team.atlassianBacklogCache.insertChildIssue",
)(function* (input: {
  ...
  }).pipe(Effect.mapError(toPersistenceSqlError("t3team.atlassianBacklogCache.insertChildIssue")));
});
