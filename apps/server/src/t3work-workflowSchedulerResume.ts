/**
 * The scheduler's resume-path helpers (Epic 27), split out of `t3work-workflowScheduler.ts` to
 ...
 * `orphanIfSleeping` (t3work-workflowEngineDurability.ts) uses, so a late/duplicate due-timer fire
