...
export type T3TeamStartChildProject = {
...
export type T3TeamStartChildLoadThreadProject = (
  threadId: ThreadId,
) => Effect.Effect<
  { readonly project: T3TeamStartChildProject; readonly thread: T3TeamStartChildThread },
