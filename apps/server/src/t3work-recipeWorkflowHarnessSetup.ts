...
export const T3WORK_HARNESS_ISO = "2026-07-20T08:00:00.000Z";

export function prepareT3workRecipeHarnessProject(input: {
  ...
  return Effect.gen(function* () {
    ...
    const recipe = yield* Effect.promise(() => loadT3workRecipeHarnessRecipe(input.recipeDir));
...
export function cleanupT3workRecipeHarnessRoots(roots: {
