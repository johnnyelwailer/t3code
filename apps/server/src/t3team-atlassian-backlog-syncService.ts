...
export type T3TeamAtlassianBacklogSyncRequest = {
 ...
 */
export function kickT3TeamAtlassianBacklogBackgroundSync(input: T3TeamAtlassianBacklogSyncRequest) {
  ...
  return runBacklogSyncWalk(input, isSuperseded).pipe(
    Effect.catchCause((cause) =>
      Effect.logDebug("t3team atlassian backlog background sync failed", cause),
    ),
...
function runBacklogSyncWalk(input: T3TeamAtlassianBacklogSyncRequest, isSuperseded: () => boolean) {
