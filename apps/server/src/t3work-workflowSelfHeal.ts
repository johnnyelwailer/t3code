...
export const T3WORK_WORKFLOW_REPAIR_LIMIT = 3;
export const T3WORK_WORKFLOW_REPAIR_HARD_LIMIT = 5;
...
export const canAttemptWorkflowRepair = (input: {
  ...
  input.repairAttempts <
    Math.max(
      0,
      Math.min(
        T3WORK_WORKFLOW_REPAIR_HARD_LIMIT,
        input.maxAttempts ?? T3WORK_WORKFLOW_REPAIR_LIMIT,
      ),
    ) &&
