...
export const makeT3TeamRoutesLayer = Layer.mergeAll(
...
export const makeT3TeamServerLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    const serverApplicationLayer = Layer.mergeAll(
      HttpRouter.serve(makeT3TeamRoutesLayer, {
...
export const runT3TeamServer = Layer.launch(makeT3TeamServerLayer);
