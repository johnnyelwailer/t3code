...
import { T3TEAM_WORK_ITEMS_INDEX_PATH as WORK_ITEMS_INDEX_PATH } from "@t3tools/project-context/t3teamContextPaths";
...
export function readToolContextView(input: T3TeamTurnToolContext): ToolContextView {
