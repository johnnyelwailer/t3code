...
import { formatAgentVisiblePromptContext } from "./t3team-agentVisiblePromptContext.ts";
...
describe("formatAgentVisiblePromptContext", () => {
  it("projects agent-visible system attachments beyond views", () => {
    ...
    expect(contextText).toContain(
      "- Artifact attachment: Implementation plan (implementation-plan; .t3team/artifacts/plan.md)",
    );
    expect(contextText).toContain(
    ...
    expect(contextText).toContain("- View attachment: t3team.custom-view");
  });
