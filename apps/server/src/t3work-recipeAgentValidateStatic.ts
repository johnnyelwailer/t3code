 ...
 * (`t3work-recipeAgentValidate.ts`) and inline-source validation flows. `prepareWorkflow`/
 ...
 * AST scan the UI's play-as-shape preview uses ({@link ./t3work-workflowShapePreview.ts}).
