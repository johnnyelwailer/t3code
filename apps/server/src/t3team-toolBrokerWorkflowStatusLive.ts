/**
 * Broker-side wiring for `t3team.workflow.status`: resolves the run repository OPTIONALLY from
...
/** Build the per-thread `t3team.workflow.status` handler factory, or `undefined` when the run
