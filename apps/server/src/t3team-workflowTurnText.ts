 ...
 * journaled as data — see `t3team-sdk.askAttachments.ts`); the single place they become text is
...
import { asNamedAttachments, renderAgentAttachments } from "@t3team/sdk";
