/**
 * Broker-side wiring for `t3team.workflow.run` (ephemeral workflows, slice 1): resolves the
...
/** Build the per-thread `t3team.workflow.run` handler factory, or `undefined` when the
