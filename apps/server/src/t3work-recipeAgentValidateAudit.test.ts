 ...
 * static validate path (`t3work.recipe.validate`), so an authoring agent sees them BEFORE a run.
 * The scan rules themselves are covered in packages/t3work-sdk/src/t3work-sdk.staticAudit.test.ts.
 */
