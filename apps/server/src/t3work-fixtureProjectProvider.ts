...
export class T3workFixtureIntegrationProvider implements IntegrationProvider {
   ...
   * are used (`t3work-atlassian-routes.ts`, the asset-content route). A fixture bundle ships
