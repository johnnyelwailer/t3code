export type T3TeamJiraRelationshipKeys = {
...
export function extractT3TeamJiraRelationshipKeys(raw: unknown): T3TeamJiraRelationshipKeys {
...
export function normalizeT3TeamJiraKey(value: unknown): string | undefined {
