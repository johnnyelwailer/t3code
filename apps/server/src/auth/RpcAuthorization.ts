...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverGetResourcePressure]: AuthOrchestrationReadScope,
  [WS_METHODS.serverSweepStorageNow]: AuthOrchestrationOperateScope,
  ...
  // t3team: reuses terminal:operate rather than introducing a new scope — signing a tool in spawns
  // a pty process exactly like the terminal does, and every standard client session already carries
  // this scope (see AuthStandardClientScopes in packages/contracts/src/auth.ts).
