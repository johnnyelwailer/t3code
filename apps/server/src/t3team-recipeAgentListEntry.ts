 ...
 * `t3team.recipe.list`, regardless of whether the directory lives in the project's
 * `.t3team/recipes/*` or inside a pack (Epic 16 §Recipe Sources And Precedence).
 *
 * Extracted from {@link ./t3team-recipeAgentList.ts} so project-local and pack enumeration share
...
import type { RecipeListEntry, RecipeToolIssue } from "@t3team/sdk";
...
import { staticRecipeText } from "./t3team-projectRecipeMetadata.ts";
import {
