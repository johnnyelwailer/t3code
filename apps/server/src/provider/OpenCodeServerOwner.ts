              ...
              runtime
                .startOpenCodeServerProcess({
                  ...
                  ...(input.serverPassword !== undefined
                    ...
                    : {}),
                  // Fork packs ship a custom OpenCode config; forward it to the
                  // local server the same way the probe path does. Only when
                  // actually set — an empty override would hide the user's own
                  // OpenCode config.
