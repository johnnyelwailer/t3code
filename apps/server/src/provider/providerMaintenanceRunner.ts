            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Nexi AI could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Nexi AI still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
