...
type MenuValue = ReturnType<typeof useT3workComposerCommandMenu>;
...
function renderMenu(initialText: string) {
  ...
  const applied: T3workComposerMenuAppliedText[] = [];
  ...
  function Probe() {
    captured.current = useT3workComposerCommandMenu({
      sources: SOURCES,
      pathSearch: null,
...
describe("useT3workComposerCommandMenu host seams", () => {
