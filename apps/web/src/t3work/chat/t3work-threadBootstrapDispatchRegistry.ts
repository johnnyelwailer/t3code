 ...
 * to live in a `useRef` inside {@link import("./t3work-useThreadBootstrap").useThreadBootstrap}. A
 ...
 * ({@link import("./t3work-recipeLaunchDedup")}). Every `useThreadBootstrap` instance for a thread
