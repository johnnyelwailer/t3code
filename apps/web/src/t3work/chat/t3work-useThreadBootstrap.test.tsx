...
import { clearThreadBootstrapDispatchStates } from "~/t3work/chat/t3work-threadBootstrapDispatchRegistry";
...
function createRecipeKickoffWorkflow(): T3workKickoffWorkflow {
  return {
    kind: "recipe",
    ...
    recipePath: "/tmp/project-alpha/.t3work/recipes/status-report-prefill",
    workflowPath: "/tmp/project-alpha/.t3work/recipes/status-report-prefill/workflow.ts",
  } as T3workKickoffWorkflow;
}
