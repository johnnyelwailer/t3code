...
} from "~/t3team/t3team-recipeManagerModel";
...
function recipe(input: Partial<ManagedProjectRecipe>): ManagedProjectRecipe {
  return {
    ...
    editable: true,
    deletable: true,
    recipePath: "/workspace/project-one/.t3team/recipes/recipe",
    sourcePath: "/workspace/project-one/.t3team/recipes/recipe/recipe.json",
    ...input,
  };
}
