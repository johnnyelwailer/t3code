 ...
 * `ctxRef`. Extracted verbatim from t3team-PlanningSpaceView.tsx.
 */

import type { MutableRefObject } from "react";

import type { DropContext, PlanningHit } from "./t3team-planningSpaceInteractions";
import { UNASSIGNED_OWNER_KEY } from "./t3team-planningSpaceLayout";
import {
  navigatePlanningItem,
  resolvePlanningNavigationCurrentId,
} from "./t3team-planningSpaceNavigation";
import { cameraZForStoryScale } from "./t3team-planningSpaceScene";
import type { EngineEdge } from "./t3team-planningSpaceRenderer";
import { GAUGE_ANCHOR_SCALES } from "./t3team-planningSpaceViewConstants";
import { createPlanningDropContext, planningHitOf } from "./t3team-planningSpaceHitTest";
