...
} from "~/t3team/stories/t3team-recipeManagerFixtures";
      ...
      <div className="flex h-screen bg-background text-foreground">
        {withSidecar ? (
          <ResizableRightSidebarLayout
            storageKey="t3team_storybook_recipe_manager_sidebar"
            collapsedStorageKey="t3team_storybook_recipe_manager_sidebar_collapsed"
            minAsideWidth={22 * 16}
...
const meta = {
  title: "T3Team/Recipes/Manager Page",
