...
export const releaseChecklistRecipe: ManagedProjectRecipe = {
  ...
  active: true,
  recipePath: "/workspace/project-alpha/.t3team/recipes/release-checklist",
  sourcePath: "/workspace/project-alpha/.t3team/recipes/release-checklist/recipe.json",
  promptPath: "/workspace/project-alpha/.t3team/recipes/release-checklist/prompt.md",
...
export const sprintRetroRecipe: ManagedProjectRecipe = {
  ...
  active: true,
  recipePath: "/workspace/project-alpha/.t3team/recipes/sprint-retro",
  sourcePath: "/workspace/project-alpha/.t3team/recipes/sprint-retro/recipe.json",
  promptPath: "/workspace/project-alpha/.t3team/recipes/sprint-retro/prompt.md",
...
export const bugTriageRecipe: ManagedProjectRecipe = {
  ...
  active: false,
  recipePath: "/workspace/project-alpha/.t3team/recipes/bug-triage",
  sourcePath: "/workspace/project-alpha/.t3team/recipes/bug-triage/recipe.json",
  promptPath: "/workspace/project-alpha/.t3team/recipes/bug-triage/prompt.md",
...
export const onboardingRecipe: ManagedProjectRecipe = {
  ...
  active: true,
  deletable: false,
  recipePath: "/workspace/project-alpha/.t3team/recipes/onboarding-guide",
  sourcePath: "/workspace/project-alpha/.t3team/recipes/onboarding-guide/recipe.json",
  promptPath: "/workspace/project-alpha/.t3team/recipes/onboarding-guide/prompt.md",
  prompt: [
