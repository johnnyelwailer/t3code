...
import {
  ...
  type T3TeamProjectSetupCardOption,
} from "~/t3team/t3team-projectSetupProfileCatalog";

export { listT3TeamProjectSetupCardOptions } from "~/t3team/t3team-projectSetupProfileCatalog";
export type { T3TeamProjectSetupCardOption } from "~/t3team/t3team-projectSetupProfileCatalog";

function CardIcon({ option, compact }: { option: T3TeamProjectSetupCardOption; compact: boolean }) {
  if (option.iconSrc) {
    return (
      <img
        src={option.iconSrc}
...
export function T3TeamProjectSetupProfileCards({
  selectedProfileId,
  onSelectProfile,
  compact = false,
  profiles,
}: {
  selectedProfileId: T3TeamProjectSetupProfileId;
  onSelectProfile: (profileId: T3TeamProjectSetupProfileId) => void;
  compact?: boolean;
  ...
  const options = listT3TeamProjectSetupCardOptions(profiles);
