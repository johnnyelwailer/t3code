...
/**
 * The play-as-shape "plan" card (recipe-UX design pass): the `t3team.workflow.shape` view
...
describe("workflow shape card in the timeline", () => {
  it("keeps authored steps in order when a phase appears again later", async () => {
    const { groupT3TeamShapeSteps } = await import("~/t3team/chat/t3team-messageShapeCard");
    const groups = groupT3TeamShapeSteps({
      name: "ordered",
