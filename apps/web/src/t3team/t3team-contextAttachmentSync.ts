...
} from "~/t3team/t3team-contextAttachmentSyncProgress";
...
const attachmentSyncPromiseById = new Map<string, Promise<T3TeamContextAttachment>>();
...
export async function syncContextAttachmentFromRequest(input: {
  ...
  onUpdate?: ((attachment: T3TeamContextAttachment) => void) | undefined;
}): Promise<T3TeamContextAttachment> {
