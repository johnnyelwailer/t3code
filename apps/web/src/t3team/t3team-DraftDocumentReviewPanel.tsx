...
import {
  ...
  T3SurfacePanel,
} from "~/t3team/components/ui/t3team-surface";
import { DraftDocumentCompare } from "~/t3team/t3team-DraftDocumentCompare";
import { DraftDocumentContent } from "~/t3team/t3team-DraftDocumentContent";
import type { T3TeamDocumentDraftMutation } from "~/t3team/t3team-draftMutationTypes";

type DraftDocumentReviewPanelProps = {
  readonly draft: T3TeamDocumentDraftMutation;
...
function fieldLabel(field: T3TeamDocumentDraftMutation["field"]): string {
