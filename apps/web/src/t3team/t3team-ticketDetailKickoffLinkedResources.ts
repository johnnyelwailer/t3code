...
import type { T3TeamSidecarRecipeLinkedResource } from "~/t3team/t3team-sidecarRecipes";
...
}): ReadonlyArray<T3TeamSidecarRecipeLinkedResource> {
  const resources: T3TeamSidecarRecipeLinkedResource[] = [];
