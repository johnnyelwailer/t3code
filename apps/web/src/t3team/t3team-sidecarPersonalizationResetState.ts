...
export type T3TeamSidecarResetPlan = {
...
export function buildT3TeamSidecarSectionResetPlan(input: {
  ...
  } satisfies T3TeamSidecarResetPlan;
}

export function buildT3TeamSidecarItemResetPlan(input: {
  readonly sectionId: string;
