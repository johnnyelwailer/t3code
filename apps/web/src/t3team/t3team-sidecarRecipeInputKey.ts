...
export function buildT3TeamSidecarRecipeInputKey(input: T3TeamSidecarRecipeInput): string {
...
export function buildT3TeamSidecarRecipeMembershipKey(input: T3TeamSidecarRecipeInput): string {
  return JSON.stringify({
    surface: input.surface,
    project: {
      id: input.project.id,
