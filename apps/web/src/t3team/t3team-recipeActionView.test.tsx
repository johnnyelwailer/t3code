...
import {
  compileT3TeamRecipeActionView,
  T3TeamCompiledRecipeActionView,
} from "~/t3team/t3team-recipeActionView";
...
async function renderBundledRecipeActionView(input: {
  ...
  readonly context: Parameters<typeof T3TeamCompiledRecipeActionView>[0]["context"];
}) {
  ...
  const CompiledActionView = await compileT3TeamRecipeActionView(recipe.actionViewTemplate);

  return renderToStaticMarkup(
    <T3TeamDashboardRecipeActionProvider>
      <RecipeLaunchControlsProvider>
        <T3TeamCompiledRecipeActionView Component={CompiledActionView} context={input.context} />
      </RecipeLaunchControlsProvider>
    </T3TeamDashboardRecipeActionProvider>,
  );
}

describe("compileT3TeamRecipeActionView", () => {
  it("renders spec-style action.mdx with host-owned components and ctx props", async () => {
    const CompiledActionView = await compileT3TeamRecipeActionView(`
