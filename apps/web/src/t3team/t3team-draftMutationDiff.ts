...
export type T3TeamDraftDiffRow = {
...
export function draftContentToComparableText(content?: T3TeamDraftRichContent): string {
  if (!content) return "";
...
export function buildDraftTextDiff(input: {
  readonly current?: T3TeamDraftRichContent;
  readonly proposed: T3TeamDraftRichContent;
}): T3TeamDraftDiffRow[] {
