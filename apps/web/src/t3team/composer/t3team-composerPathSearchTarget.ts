...
export type T3TeamComposerPathSearchTarget = {
  readonly environmentId: EnvironmentId | null;
  readonly cwd: string | null;
 ...
 */
export function resolveT3TeamComposerPathSearchTarget(
  trigger: ComposerTrigger | null,
  scope: T3TeamComposerPathSearchScope | null,
): T3TeamComposerPathSearchTarget {
...
export function isT3TeamComposerPathSearchTargetQueryable(
  target: T3TeamComposerPathSearchTarget,
): boolean {
  return (
