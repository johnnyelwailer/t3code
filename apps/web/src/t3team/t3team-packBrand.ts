...
export type T3TeamPackBrandAssets = NonNullable<EnvironmentAppearance["brand"]>;

export function pickT3TeamPackBrandAsset(
...
const FAVICON_ID = "t3team-pack-favicon";
...
export function applyT3TeamPackFavicon(markDataUrl: string | undefined): void {
