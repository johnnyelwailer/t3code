...
function createLocalRecipe(id: string): ProjectRecipeDiscovered {
  return {
    ...
    promptPath: `/tmp/project-alpha/.t3team/recipes/${id}/prompt.md`,
    recipePath: `/tmp/project-alpha/.t3team/recipes/${id}`,
    workflowPath: `/tmp/project-alpha/.t3team/recipes/${id}/workflow.ts`,
    allowedToolGroups: [],
  };
}
...
function QuickStartProbe({
  ...
  const quickStarts = useT3TeamSidecarRecipeQuickStarts({
    backend,
...
describe("useT3TeamSidecarRecipeQuickStarts", () => {
