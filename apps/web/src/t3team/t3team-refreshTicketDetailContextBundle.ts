...
import type { T3TeamWorkItemSliceContextRefreshResult } from "~/t3team/t3team-workItemContextRefreshTypes";
...
export async function refreshTicketDetailContextBundle(input: {
  ...
  const result: T3TeamWorkItemSliceContextRefreshResult =
