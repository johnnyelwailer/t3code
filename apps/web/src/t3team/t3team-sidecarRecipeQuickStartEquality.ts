...
function areComposerGuidanceEqual(
  left: T3TeamSidecarRecipeQuickStart["composerGuidance"],
  right: T3TeamSidecarRecipeQuickStart["composerGuidance"],
): boolean {
  if (left === right) {
    return true;
  }
...
function areQuickStartWorkflowsEqual(
  left: T3TeamSidecarRecipeQuickStart["workflow"],
  right: T3TeamSidecarRecipeQuickStart["workflow"] | undefined,
): boolean {
  if (left === right) {
    return true;
  }
...
function areQuickStartActionViewsEqual(
  left: T3TeamSidecarRecipeQuickStart["actionView"],
  right: T3TeamSidecarRecipeQuickStart["actionView"],
): boolean {
  if (left === right) {
    return true;
  }
...
export function areQuickStartsEqual(
  left: ReadonlyArray<T3TeamSidecarRecipeQuickStart>,
  right: ReadonlyArray<T3TeamSidecarRecipeQuickStart>,
): boolean {
  if (left === right) {
    return true;
  }
