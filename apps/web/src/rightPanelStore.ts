...
// v12 adds the device surface (upstream) and "thread" surfaces (fork side chats);
// v13 is upstream's device bump — the fork's thread-surface migration validates their references.
