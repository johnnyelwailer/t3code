// This file mostly exists because we want dev mode to say "Nexi AI (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Nexi AI (Dev)" : "Nexi AI (Alpha)";
